...
.incorrect-ego-bookmarklet {
  ...
  blooketHacksButton.addEventListener("click", () => {
    const popupContent = `
      <div class="EgoWindowPopoutTitle"><a href="https://play.blooket.com/play" target="_blank">Blooket</a> Hacks</div>
    ...
    var button = document.getElementById("showBlooketGUIEGO");
    if (button) {
      openABCPage(button, "https://05konz.github.io/Blooket-Cheats/");
    }
